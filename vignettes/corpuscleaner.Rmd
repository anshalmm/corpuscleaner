...
It also includes a function called `novels_by_ID` which minimizes using the entire `novels()` tibble for text analysis, and instead pick, by ID, the document of your choice and column names, such as the year the novel was published, the author of the novel, or both.
