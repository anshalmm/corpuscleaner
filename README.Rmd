...
Then we can use the `novels_by_ID` function to extract the ID, text, and an additional column, author, for the document `Vathek`.
...
If you would like to know more about this package, please see the Get started Page.  
